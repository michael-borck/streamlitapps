...
#
# individual apps must be in the library folder 'stapps'
...
import pkgutil
import importlib
import stapps    # default library name for apps
...
package = stapps # default name for the library containg the apps
...
for importer, modname, ispkg in pkgutil.iter_modules(package.__path__):
    ...
    if modname.startswith('_'):
        ...
        m = importlib.import_module('.'+modname,'stapps')
